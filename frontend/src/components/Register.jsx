...
const Register = () => {
	...
	return (
		...
		>
			{/* <div className="absolute right-0 w-1/2 h-3/4">
				<img
					className="object-scale-down w-3/4 absolute invisible md:visible bottom-0 right-24"
					src={statue}
...
<div className="w-full h-fit flex justify-center align-middle">
						<form
							id="userForm"
							class="justify-center mt-[20px] md:mt-[20px] w-2/3 md:w-1/3 flex flex-col z-10"
							onSubmit={(e) => onSubmit(e)}
						>
							<input
								id="email"
